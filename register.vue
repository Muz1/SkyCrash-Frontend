        ...
        <form class="flex flex-col gap-md mt-sm" @submit.prevent="handleSubmit">
          ...
          <div class="flex items-center mt-2 pl-1">
            ...
            <label class="ml-3 font-body-md text-sm text-white/60 cursor-pointer" for="terms">
              I agree to the
              <a
                class="text-primary hover:text-primary-fixed hover:drop-shadow-[0_0_5px_rgba(255,180,169,0.5)] transition-all"
                href="#"
                @click.prevent="$emit('view-terms')"
              >Flight Terms</a>
            </label>
          </div>
...
export default {
  ...
  emits: ["register", "view-terms", "go-to-login"],
  data() {
    return {
      form: {
        pilotName: "",
