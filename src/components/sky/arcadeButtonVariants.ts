...
export type ArcadeButtonVariant = NonNullable<
  Parameters<typeof arcadeButton>[0]
>['variant']
export type ArcadeButtonSize = NonNullable<Parameters<typeof arcadeButton>[0]>['size']
